...
from degree_progression_view import degree_progression_view
...
with st.sidebar:
    ...
    view_options = ["Student Eligibility View", "Full Student View", "Degree Progression", "Degree Plan"]
...
if has_data:
    ...
    if st.session_state.active_view == "Student Eligibility View":
        ...
        full_student_view()
    elif st.session_state.active_view == "Degree Progression":
        degree_progression_view()
