...
## Recent Changes
- **2025-11-03**: Replaced Visualizations tab with comprehensive Course Dependency Tree showing ALL courses in one view. Courses are grouped by prefix (PBHL, SPTH, etc.) in collapsible expanders. Each course displays its prerequisites (🔴 red), concurrent requirements (🟡 yellow), and corequisites (🟢 green) inline. Removed all bar charts and scatter plots.
