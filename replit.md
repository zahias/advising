...
## Recent Changes
- **2025-11-03**: Added course dependency tree visualization to Course Planning tab. Interactive tree view shows prerequisites (🔴 red), concurrent requirements (🟡 yellow), and corequisites (🟢 green) for each course, including both incoming requirements and outgoing dependencies (courses that require the selected course).
