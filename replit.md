...
## Recent Changes
- **2025-11-06**: Made REQUISITES and SUMMARY rows non-sortable in Degree Progression view by switching from interactive dataframe to static table display. This prevents special rows from getting mixed with student data when sorting columns.
