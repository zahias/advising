...
- **2025-11-06**: Consolidated Degree Progression functionality into Full Student View by adding semester filtering. Removed separate Degree Progression tab. Users can now filter Full Student View by specific semester (Fall-1, Spring-2, etc.) or semester type (Fall, Spring, Summer) to see semester-grouped data. When filtering is active, REQUISITES and SUMMARY appear as greyed-out subheadings above the table instead of as table rows, keeping the student data table fully sortable.
