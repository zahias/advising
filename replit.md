...
## Recent Changes
- **2025-11-03**: Removed Course Planning view entirely. Replaced with visual Course Dependency Tree showing interactive flowchart of all courses with prerequisite arrows (similar to curriculum map). Uses NetworkX for graph layout and Plotly for interactive visualization. Courses color-coded by department (green=Public Health, orange=General Education, yellow=Electives). Black arrows show prerequisites, red arrows show concurrent requirements.
